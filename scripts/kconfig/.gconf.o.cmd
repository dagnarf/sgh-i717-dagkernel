cmd_scripts/kconfig/gconf.o := gcc -Wp,-MD,scripts/kconfig/.gconf.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer   -DCURSES_LOC="<ncurses.h>" -DLOCALE  `pkg-config --cflags gtk+-2.0 gmodule-2.0 libglade-2.0` -D LKC_DIRECT_LINK -c -o scripts/kconfig/gconf.o scripts/kconfig/gconf.c
...
deps_scripts/kconfig/gconf.o := \
  ...
  /usr/lib/gcc/x86_64-pc-linux-gnu/4.6.2/include/float.h \
  /usr/include/time.h \
