...
static uint32 csc_matrix_dmap_tab[9] = {
	0x0200, 0x0000, 0x0000,
	0x0000, 0x0200, 0x0000,
	0x0000, 0x0000, 0x0200
};

static uint32 csc_pre_bv_dmap_tab[3] = {0, 0, 0 };
static uint32 csc_post_bv_dmap_tab[3] = {0, 0, 0 };

static  uint32 csc_pre_lv_dmap_tab[6] =  {0, 0xff, 0, 0xff, 0, 0xff };
static  uint32 csc_post_lv_dmap_tab[6] = {0, 0xff, 0, 0xff, 0, 0xff };
...
void mdp4_dmap_csc_mv_setup(void)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 9; i++) {
		outpdw(off, csc_matrix_dmap_tab[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_dmap_csc_pre_bv_setup(void)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 3; i++) {
		outpdw(off, csc_pre_bv_dmap_tab[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_dmap_csc_post_bv_setup(void)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 3; i++) {
		outpdw(off, csc_post_bv_dmap_tab[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_dmap_csc_pre_lv_setup(void)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 6; i++) {
		outpdw(off, csc_pre_lv_dmap_tab[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_dmap_csc_post_lv_setup(void)
{
	...
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_ON, FALSE);
	for (i = 0; i < 6; i++) {
		outpdw(off, csc_post_lv_dmap_tab[i]);
		off++;
	}
	mdp_pipe_ctrl(MDP_CMD_BLOCK, MDP_BLOCK_POWER_OFF, FALSE);
}
...
void mdp4_dmap_csc_setup(void)
{
	...
	outpdw(MDP_BASE + 0x90070, 0x08);/* enable DMA P CSC */
}

static uint32_t mdp4_csc_block2base(mdp_block_type block)
{
	uint32_t base = 0x0;
	switch (block){
